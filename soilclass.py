...
data = pd.read_csv('soil-class.csv')
...
plt.title("Soil class histogram")
plt.xlabel("Class")
...
ax.xaxis.set_ticklabels(['Non-soil', 'soils']); ax.yaxis.set_ticklabels(['Non-soil', 'soils']);
...
print("Percentage of soil transactions: ", len(under_sample_data[under_sample_data.Class == 1])/len(under_sample_data))
...
ax.set_xlabel('Predicted labels');ax.set_ylabel('True labels'); 
ax.set_title('Logistic regression: Confusion Matrix'); 
ax.xaxis.set_ticklabels(['Non-soil', 'soils']); ax.yaxis.set_ticklabels(['Non-soils', 'soils']);
